...
<div class="container-fluid px-4 mt-4">
    <div class="d-flex align-items-center mb-3">
        ...
        <h3 class="font-weight-bold mb-0">Certificate of Solo Parent</h3>`
    </div>
    <div class="shadow">
        <div class="card-body">
            <form action="index.php?controller=forms&action=processCoSoloParentEntry" target="_blank" method="POST">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <select class="form-control selectpicker" id="constituent_id" name="constituent_id"
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="dependents" name="dependents"
                            placeholder="Enter dependents separated by comma"
