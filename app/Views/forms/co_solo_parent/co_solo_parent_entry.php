...
<div class="container-fluid px-4 mt-3">
    ...
    <form action="index.php?controller=forms&action=processCoSoloParentEntry" target="_blank" method="POST">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <input type="text" class="form-control" id="dependents" name="dependents"
                        placeholder="e.g. JUAN DELA CRUZ JR., MARIA DELA CRUZ"
                    ...
                    <div class="field-hint">
                        ...
                        Enter full names of dependents separated by a comma
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea class="form-control" id="purpose" name="purpose" rows="5"
                        placeholder="e.g. For solo parent ID application, financial assistance..." required></textarea>
                </div>
