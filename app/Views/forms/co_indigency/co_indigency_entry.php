...
<div class="container-fluid px-4 mt-4">
    <div class="d-flex align-items-center mb-3">
        ...
        <h3 class="font-weight-bold mb-0">Certificate of Indigency</h3>
    </div>
    <div class="shadow">
        <div class="card-body">
            <form action="index.php?controller=forms&action=processCoIndigencyEntry" target="_blank" method="POST">
                <div class="row">
