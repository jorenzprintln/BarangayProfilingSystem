...
class PDF extends FPDF
{
    ...
    public function unemploymentCertificate($constituent, $purpose, $date, $punongBarangay)
    {
        $this->AddPage();
        $this->SetFont('Times', 'B', 14);
        $this->Cell(0, 1, 'C E R T I F I C A T E  O F  U N E M P L O Y M E N T', 0, 1, 'C');
        $this->Ln(10);
...
$pdf = new PDF();
$pdf->unemploymentCertificate($constituent, $purpose, $date, $punongBarangay);
...
ob_end_clean();
$pdf->Output('I', 'Certificate of Unemployment.pdf');
exit;
