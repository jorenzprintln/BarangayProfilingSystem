...
@media (max-width: 576px) {
    .account-settings-wrap { padding: 0 .5rem 2rem; }
    ...
    <div class="account-settings-wrap">
        ...
        <?php if (Session::hasFlash('success')): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert"
                 style="border-radius:.75rem; border:none; border-left:4px solid #22c55e; background:#f0fdf4; color:#166534;">
        ...
        <?php if (Session::hasFlash('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert"
                 style="border-radius:.75rem; border:none; border-left:4px solid #ef4444; background:#fef2f2; color:#991b1b;">
        ...
        <div class="page-header">
            <div class="page-title">
                ...
                <div>
                    ...
                    <p class="mb-0 mt-1" style="opacity:0.9;font-size:0.9rem;">Update your login and account information</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <span class="form-card-header-label">My Account</span>
            </div>

            <form method="POST" action="index.php?controller=constituent&action=saveAccountSettings" id="constituentAccountSettingsForm">
                ...
                <div class="form-card-body">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-hint">
                            ...
                            Your display name shown in the system
                        </div>
                    </div>

                    <!-- [EMAIL DISABLED] - uncomment when email verification is re-enabled -->
                    <?php /*
                    <div class="field-group">
                ...
                <div class="form-card-footer">
                    <a href="index.php?controller=constituent" class="btn-cancel-form">Cancel</a>
