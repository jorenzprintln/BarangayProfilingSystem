...
<script>
    ...
    <div class="content-wrapper">
        ...
        <?php if (!empty($profileRequestHistory)): ?>
            <div class="alert alert-info" role="alert" style="border-radius:.75rem;">
                <i class="fas fa-info-circle mr-2"></i>
                <strong>Check Your Request Status:</strong> View all your profile submission updates and status in 
                <a href="index.php?controller=constituent&action=myRequests" style="font-weight:600;">My Requests</a>
            </div>
        <?php endif; ?>

        <?php if (!empty($isLinkedToConstituent) && empty($profileRequest)): ?>
            <div class="alert alert-secondary" role="alert" style="border-radius:.75rem;">
                <strong>Current Record Loaded:</strong> This form shows your approved data. Save changes to submit a new update request.
            </div>
        <?php endif; ?>
        ...
        <div class="page-header">
            <div class="d-flex align-items-center mt-3">
                ...
                <div>
                    ...
                    <p class="mb-0 mt-1" style="opacity:0.9;font-size:0.95rem;">Fill in your information. Changes are subject to secretary verification before approval.</p>
                </div>
            </div>
        </div>

        <form action="index.php?controller=constituent&action=saveProfile" method="post" id="constituentForm" novalidate>
            ...
            <div class="form-card">
                ...
                <div class="classification-grid">
                    <?php foreach ($classifications as $classification): ?>
                        <?php
                        $isChecked = isset($data['classifications']) && in_array((string)$classification['id'], array_map('strval', $data['classifications']));
                        ...
                        <div class="<?= $itemClass ?>" id="classification-item-<?= $classification['id'] ?>">
                            <div class="classification-checkbox">
                                ...
                                <?= $isChecked ? 'checked data-saved="1"' : '' ?>
        ...
        <div class="modal-content" style="border-radius:1rem;border:none;overflow:hidden;">
            ...
            <div class="modal-body" style="padding:2rem;">
                <p style="color:#4a5568;font-size:1rem;margin-bottom:1rem;">
                    The PhilSys Number (PSN) you entered is <strong>already registered</strong>.
                </p>
                ...
                <p style="color:#718096;font-size:0.875rem;margin:0;">
                    Please verify the PSN and try again.
                </p>
            </div>
